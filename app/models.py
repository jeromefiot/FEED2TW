...
class Article(db.Model):
    ...
    date_tweeted = db.Column(db.DateTime())
...
class Feed(db.Model):
    ...
    hashtag = db.Column(db.String(128))
    # tweets / day
    frequency = db.Column(db.Integer, default=2)
    collect_actif = db.Column(db.Boolean, default=True)
    Tweet_actif = db.Column(db.Boolean, default=True)
